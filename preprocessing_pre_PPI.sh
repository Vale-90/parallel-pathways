## Preprocessing of the data before ts extraction for PPIs. Preprocessing includes: motion correction - fieldmap unwarping - registration to MNI template - FILM prewhitening - Physiological noise modelling ##
...
# Output directory
set fmri(outputdir) "/home/vo16427/Data/'${i}'/tests/all_corrections_no_ST"
...
set highres_files(1) "/home/pywer/Data/'${i}'/highres_new_brain"

# EV 1 title
set fmri(evtitle1) "all_zeros"
...
# Custom EV file (EV 1)
set fmri(custom1) "/home/vo16427/Data/zeros.txt"
...
'  > all_corrections_noST.fsf;
$FSLDIR/bin/feat all_corrections_noST.fsf
rm all_corrections_noST.fsf
done
);
